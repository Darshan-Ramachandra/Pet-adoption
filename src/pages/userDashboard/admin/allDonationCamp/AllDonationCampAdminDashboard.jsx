...
import AllDonationCampAdmin from './AllDonationCampAdmin';
import { AuthContext } from '../../../../components/providers/AuthProvider';
import { useContext } from 'react';

const AllDonationCampAdminDashboard = () => {
  ...
  return (
    <div className='grid grid-cols-4'>
      ...
      <div className=' min-h-[100vh] bg-pink-100 lg:col-span-3 col-span-4 '>
        ...
        {/* con */}
<AllDonationCampAdmin></AllDonationCampAdmin>
...
export default AllDonationCampAdminDashboard;